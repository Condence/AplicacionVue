...
router.get(`/api/${config.api.version}/user/name/:idUsuario`, middlewares.tokenMiddleware, usuarioController.getName);  // Publico
...
router.get(`/api/${config.api.version}/posiblesconocidos/:idUsuario`, middlewares.tokenMiddleware, conocidoController.getPosiblesConocidos); // Privado
